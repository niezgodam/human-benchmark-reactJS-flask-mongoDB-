export default function GoldenMedal({ width = 90 }: { width?: number }) {
  return (
    <svg viewBox="0 0 120 120" width={`${width}px`} height={`${width}px`}>
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          ></polygon>
          <circle className="st1" cx="60" cy="46.4" r="32.2"></circle>
          <circle className="st2" cx="60" cy="46.4" r="25.3"></circle>
          <path
            className="st3"
